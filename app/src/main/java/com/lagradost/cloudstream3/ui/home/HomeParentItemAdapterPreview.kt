...
class HomeParentItemAdapterPreview(
    ...
    private class HeaderViewHolder(
        ...
        private fun showAniListGenreFilter(context: Context) {
            ...
            val genresAdapter = AniListFilterUtils.AniListCheckboxAdapter(genres, selectedGenres, { item, isChecked ->
                if (isChecked) {
            ...
            // Setup tags adapter
            val tagsAdapter = AniListFilterUtils.AniListCheckboxAdapter(tags, selectedTags, { item, isChecked ->
                if (isChecked) {
